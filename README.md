...
- 8 выполненных тестовых заданий (backend и analytics)
- Каждое задание в отдельной папке с README, TASK.md, SCREEN.md
...
|---:|---|---|---|---|
| 01 | backend | Bewise | Quiz questions API (FastAPI + PostgreSQL) | [01_backend_Bewise]([01_backend_Bewise/](https://github.com/pelagus0/domashka/tree/bewise/01_backend_Bewise)) |
